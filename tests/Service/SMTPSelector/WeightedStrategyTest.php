...
final class WeightedStrategyTest extends TestCase
{
    ...
    public function testSelectMultipleConfigsEqualWeights(): void
    {
        // 创建权重相同的多个配置
    ...
    public function testSelectMultipleConfigsDifferentWeights(): void
    {
        // 创建权重不同的多个配置
        $config1 = new SMTPConfig();
        $config1->setName('Config 1');
    ...
    public function testSelectMultipleConfigsZeroWeights(): void
    {
        // 创建权重为零的配置
        $config1 = new SMTPConfig();
        $config1->setName('Config 1');
    ...
    public function testSelectAllZeroWeights(): void
    {
        // 创建所有配置权重都为零的情况
        $config1 = new SMTPConfig();
        $config1->setName('Config 1');
